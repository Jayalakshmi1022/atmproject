...
public class AtmSystem {
		 ...
		 public void atm_start() throws InsufficientBalance, AccountNotFound, InvalidCrediential {
			...
			// ======= admin login ======
			public void adminLogin() throws AccountNotFound, InvalidCrediential {
				...
				if(admin.login(pass)) {
					...
					while(true) {
						...
						int choice = sc.nextInt();sc.nextLine();
						switch(choice) {
						case 1: admin.viewAllAccounts(accounts,accountCount); break;
					...
					throw new InvalidCrediential(" Invalid Credientials");
				}
			}
			//user login
			public void accountLogin() throws InsufficientBalance, InvalidCrediential {
				System.out.print("Enter Account Number: ");
				String accNum = sc.nextLine();
				...
				if(account!=null) {
					...
					while(true) {
			             ...
			             case 2:  System.out.print("Enter Amount to Deposit: ");
			             			...
			             			sc.nextLine(); break;
			             case 3:System.out.println("total balance");
			            	     atm.checkBalance(account); break;
			             case 4: System.out.println("Logging Out..!"); return;
			             default: System.out.println("Invalid choice..!");
			             }
					}
				}else {
					throw new InvalidCrediential("Invalid account details");
				}
			}
			public static void main(String[] args) throws InsufficientBalance, AccountNotFound, InvalidCrediential {
